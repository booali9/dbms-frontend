...
const LocationTracker = () => {
    ...
    try {
      navigator.geolocation.getCurrentPosition(
        async (position) => {
          ...
          if (role === 'point') {
            startLocationUpdates(userId, longitude, latitude);
          }
  ...
  return (
    <div className="location-tracker" style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>Live Location Tracking System</h2>
      ...
      <div style={{ marginBottom: '20px', display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
        ...
        >
          ...
          <option value="point">Point User (Delivery, etc.)</option>
